...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-signup-signup-module"], {
  ...
  function srcAppPagesSignupSignupTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignupPage = /*#__PURE__*/function () {
      function SignupPage(router, userData, request) {
      ...
      _createClass(SignupPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.request.getTheCurrentUserIdInStorage().then(function (res) {
            _this.signup.groupBelong.Leader = res;
          });
        }
      }, {
        key: "onSignup",
        value: function onSignup(form) {
          ...
          this.request.signUp(this.signup).subscribe(function (res) {
            console.log(res);

            _this2.router.navigate(['/app/tabs/schedule']);
          });
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _providers_user_data__WEBPACK_IMPORTED_MODULE_3__["UserData"], _logInAndSignupService_requests_service__WEBPACK_IMPORTED_MODULE_4__["RequestsService"]])], SignupPage);
    /***/
  }
}]);
