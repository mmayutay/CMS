...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
  ...
  function srcAppPagesLoginLoginTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/services/requests.service.ts"); // import { AlertController } from '@ionic/angular';
      ...
      _createClass(LoginPage, [{
        ...
        value: function onLogin() {
          ...
          this.request.loginService(this.login).subscribe(function (res) {
            if (res) {
              _this.userData.storage.set(_this.request.storageKey, _this.login.email);
